...
flags.DEFINE_string(
    "ckpt_dir", None,
    "The directory where the model checkpoints can be found")
  ...
  def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
    ...
    for var in tvars:
      ...
      if var.name in initialized_variable_names:
        init_string = ", *INIT_FROM_CKPT {}*".format(init_checkpoint)
...
def main(_):
  ...
  for ckpt_file, steps in fs_sorted:
    ...
    model_fn = model_fn_builder(
        ...
        init_checkpoint=os.path.join(FLAGS.ckpt_dir, ckpt_file),
